...
<div class="admin_background">
	<div class="b">
			<h1 style="font-family:Serif; font-size:70px; color:steelblue">Welcome to Admin Page, <c:out value="${loginedUser.username}"/></h1>
			<div>
		...
		<h2 style="color:silver">All Airplanes In The Club</h2>
	<%-- 		<c:if test="${alertMessage == 'alert' }">
		...
		<h2 style="color:silver">All Rentals In The Club</h2>
		<div>
			<table class="table table-dark table-hover">
				<thead>
					<tr>
